...
const CGUIMcaLang::langmapRaw CGUIMcaLang::m_eng_lang_raw[] = {
	CGUIMcaLang::langmapRaw("LNG_MWND_CHOOSE_SLOT", "Select slot"),
	CGUIMcaLang::langmapRaw("LNG_OPER_PS2_MEMORY_CARD", "PS2 Memory Card"),
	CGUIMcaLang::langmapRaw("LNG_OPER_PSX_MEMORY_CARD", "PS1 Memory Card"),
	CGUIMcaLang::langmapRaw("LNG_OPER_FORMAT", "Format"),
...
const CGUIMcaLang::langmapRaw CGUIMcaLang::m_fre_lang_raw[] = {
...
const CGUIMcaLang::langmapRaw CGUIMcaLang::m_spa_lang_raw[] = {
...
const CGUIMcaLang::langmapRaw CGUIMcaLang::m_ger_lang_raw[] = {
...
const CGUIMcaLang::langmapRaw CGUIMcaLang::m_ita_lang_raw[] = {
...
const CGUIMcaLang::langmapRaw CGUIMcaLang::m_por_lang_raw[] = {
